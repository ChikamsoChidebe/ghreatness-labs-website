...
const services = [
  {
    ...
    description: 'At Ghreatness Labs, we take pride in delivering UI/UX designs that are fully customized to your unique business needs. Our team of skilled designers blends creativity, innovation, and user-centered design principles to craft digital experiences that are not only visually striking but also intuitive and easy to navigate.',
    features: [
  ...
  },
  {
    ...
    description: 'Delivering web development solutions meticulously designed to match your business\'s unique needs, Ghreatness Labs combines the latest technologies, innovative techniques, and industry best practices to create websites that are visually striking, fast, secure, and highly functional.',
    features: [
  ...
  },
  {
    ...
    description: 'At Ghreatness Labs, we create graphic design solutions that bring your brand\'s unique identity to life. Combining creativity, modern design principles, and innovative techniques, we produce visuals that are striking, memorable, and highly effective.',
    features: [
      'Logo & Brand Identity',
      'Marketing Materials',
      'Digital Graphics',
  ...
  },
  {
    ...
    description: 'We deliver video editing solutions designed to bring your vision to life with clarity and impact. Combining creative storytelling, advanced editing techniques, and the latest software tools, we transform raw footage into engaging, professional-quality videos.',
    features: [
  ...
  },
  {
    ...
    description: 'We provide social media marketing solutions designed to elevate your brand\'s presence and engagement across all digital platforms. Leveraging data-driven strategies, creative content, and cutting-edge tools, we craft campaigns that resonate with your target audience.',
    features: [
  ...
  },
  {
    ...
    description: 'At Ghreatness Labs, we deliver software development solutions tailored to solve your unique business challenges. Our team combines innovative thinking, industry best practices, and advanced technologies to design and build applications that are robust, scalable, and user-friendly.',
    features: [
  ...
  },
  {
    ...
    description: 'We provide cybersecurity solutions designed to safeguard businesses and individuals from evolving digital threats. Our services include advanced threat detection, vulnerability management, data protection, and secure network architecture.',
    features: [
